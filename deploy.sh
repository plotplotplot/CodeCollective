...
PIDP_PUBLIC_BASE_URL="${PIDP_PUBLIC_BASE_URL:-https://id.codecollective.us}"
PIDP_FRONTEND_REDIRECT_URL="${PIDP_FRONTEND_REDIRECT_URL:-https://codecollective.us/p/auth/callback}"
PIDP_NATIVE_REDIRECT_SCHEMES="${PIDP_NATIVE_REDIRECT_SCHEMES:-org.arkavo.portal,codecollective}"
...
write_pidp_config() {
  local required=(
    ...
    PIDP_PUBLIC_BASE_URL
    PIDP_FRONTEND_REDIRECT_URL
    PIDP_NATIVE_REDIRECT_SCHEMES
...
const config = {
  ...
  vars: {
    ...
    SESSION_COOKIE_DOMAIN: env.PIDP_SESSION_COOKIE_DOMAIN || "",
    ...
    PUBLIC_BASE_URL: env.PIDP_PUBLIC_BASE_URL,
    FRONTEND_REDIRECT_URL: env.PIDP_FRONTEND_REDIRECT_URL,
    NATIVE_REDIRECT_SCHEMES: env.PIDP_NATIVE_REDIRECT_SCHEMES,
